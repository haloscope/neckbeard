...
| [0019](docs/issues/0019-unenforced-rules-in-the-byte-true-section.md) | open | Rules with no machine contradictor go unfollowed, and adopters cannot enforce them |
| [0020](docs/issues/0020-closeout-duty-has-no-trigger.md) | open | The closeout review duty fires only on human attention |
| [0021](docs/issues/0021-a-new-check-must-be-proven-to-fail.md) | open | A check that has only ever been seen green is a hypothesis |
...
| [0024](docs/issues/0024-created-is-not-delivering-data.md) | open | An artifact counts as done when it exists, not when it produces a result |
| [0025](docs/issues/0025-checks-must-name-what-they-measured.md) | open | A check that cannot name its subject proves nothing |
